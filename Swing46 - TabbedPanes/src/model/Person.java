...
public class Person implements Serializable {
	...
	public Person(int id, String name, AgeCategory ageCategory, EmploymentCategory empCategory,
			String taxId, boolean usCitizen, Gender gender, String occupation) {
		
		// this constructor calls the other constructor and then adds the id field:
		this(name, ageCategory, empCategory, taxId, usCitizen, gender, occupation);
